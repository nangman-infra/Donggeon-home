...
def REPO_SLUG = 'nangman-infra/Donggeon-home'
def MAIN_BRANCH_REF = 'refs/heads/main'
def DEFAULT_REPO_HTTP_URL = 'https://github.com/nangman-infra/Donggeon-home.git'
...
pipeline {
    ...
    triggers {
        GenericTrigger(
            ...
            causeString: 'Donggeon-home main push detected',
    ...
    environment {
        ...
        SONAR_PROJECT_KEY = 'donggeon-home'
        SONAR_PROJECT_NAME = 'donggeon-home'
        CI = 'true'
        DOCKER_BUILDKIT = '1'
                        ...
                        script {
                            ...
                            writeFile(
                                ...
                                text: """
                                    ...
                                    sonar.exclusions=**/node_modules/**,**/.next/**,**/out/**,**/coverage/**,**/dist/**,**/*.config.*,**/next-env.d.ts,**/*.test.ts,**/*.test.tsx
                                    sonar.coverage.exclusions=**/*.test.ts,**/*.test.tsx,app/opengraph-image.tsx,app/layout.tsx
